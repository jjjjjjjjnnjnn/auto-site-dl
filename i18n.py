...
STRINGS = {
    "zh": {
        ...
        "m_preset": "🎯 一键视频配置(以拿视频为目标收敛开关)",
        "preset_done": "视频配置已收敛：%s；代理/栏目/浏览器/密钥等保持不动",
        "preset_noop": "已是视频配置，无改动",
        "v_on": "开",
        "v_off": "关",
        "v_none": "无",
    ...
    "en": {
        ...
        "m_preset": "🎯 One-click video preset (converge switches for video)",
        "preset_done": "Video preset applied: %s; proxy/column/browser/keys untouched",
        "preset_noop": "Already video-ready, no changes",
        "v_on": "on",
        "v_off": "off",
        "v_none": "none",
        "v_browser_default": "chromium",
